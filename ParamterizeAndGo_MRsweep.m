...
Freqs           = [130 270 885];                    % frequencies to sweep in a single trial [kHz]
Amplitudes      = [50 200];                         % amplitudes during each trial [mV]
DutyCycle       = [20];                             % duty cycle of each burst in a trial [%]
